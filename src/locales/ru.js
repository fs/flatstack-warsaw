export default {
  translations: {
    ...
    vacancy: {
      ...
      aboutProduct:
        'Продукт относится к сфере GRC (Governance, Risk Management, Compliance) для глобального рынка.',
      role: {
        title: 'Роль',
        items: [
    ...
    warsaw: {
      title: 'Приходи к нам в Варшаве',
      description:
        'Мы работаем в современном офисе, где вы всегда найдёте подходящую атмосферу для работы, независимо от того, нужно ли вам уединённое место или нужно сконцентрировать свое внимание. Здесь есть места для парковки велосипедов, зона кафе, качели и даже комната для сна с климат-контролем.',
